...
func Wrap(e error, httpError *Error) *Error {
	return &Error{cause: e, HTTPStatus: httpError.HTTPStatus, Detail: chooseNonEmptyString(httpError.Detail, e.Error()), Instance: httpError.Instance, Type: httpError.Type}
}
